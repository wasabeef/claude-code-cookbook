---
description: 'Create detailed specifications with spec-driven development. Trigger with "write a spec", "define requirements", "clarify the spec", "detailed design", "create functional spec".'
allowed-tools:
  - Read
  - Write
  - Grep
