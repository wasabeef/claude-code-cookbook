---
description: 'Quantitative tech debt analysis and improvement plan. Trigger with "analyze tech debt", "check project health", "evaluate code debt", "create improvement plan", "debt score?".'
allowed-tools:
  - Read
  - Grep
  - Glob
