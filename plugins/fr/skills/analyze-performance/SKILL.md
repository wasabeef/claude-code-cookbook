---
description: "Analyse de performance basée sur les Core Web Vitals. Se déclenche avec « analyser les performances », « améliorer la vitesse », « vérifier les Core Web Vitals »."
allowed-tools:
  - Read
  - Grep
  - Glob
