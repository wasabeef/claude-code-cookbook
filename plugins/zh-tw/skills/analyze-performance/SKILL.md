---
description: "基於 Core Web Vitals 的效能分析和 UX 評分。「分析效能」「改善速度」「檢查 Core Web Vitals」「頁面速度」等觸發。"
allowed-tools:
  - Read
  - Grep
  - Glob
...
# 基於 Core Web Vitals 的效能分析和 UX 評分
