---
description: "基于 Core Web Vitals 的性能分析和 UX 评分。「分析性能」「改善速度」「检查 Core Web Vitals」「页面速度」等触发。"
allowed-tools:
  - Read
  - Grep
  - Glob
...
# 基于 Core Web Vitals 的性能分析和 UX 评分
