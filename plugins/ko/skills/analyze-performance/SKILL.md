---
description: "Core Web Vitals 기반 성능 분석 및 UX 스코어 산출. 「성능 분석해줘」「속도 개선하고 싶어」「Core Web Vitals 체크」「페이지 속도 조사」등으로 기동."
allowed-tools:
  - Read
  - Grep
  - Glob
...
# Core Web Vitals 기반 성능 분석 및 UX 스코어 산출
